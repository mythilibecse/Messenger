...
import 'package:chatapp/Authenticate/databaseservice.dart';
import 'package:chatapp/chat/const.dart';
import 'package:chatapp/chat/grouptile.dart';
import 'package:chatapp/chat/helperfun.dart';
import 'package:chatapp/chat/profile.dart';
...
import 'package:chatapp/chat/search_page.dart';
                         ...
                         Padding(
                           ...
                           child: GestureDetector(
                             onTap: (){
                               ...
                               child: avatar(imagepath: avatarlist[index]['avatar'].toString())),
                         )
                     ),
               )
             ],
